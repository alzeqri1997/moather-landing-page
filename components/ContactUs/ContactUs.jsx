      ...
      <div className="flex items-center justify-between" >
        <div className="text-start" >
          ...
          <div className="min-w-[504px] mt-[60px]">
            <form className="bg-white w-11/12 xl:w-auto text-[12px] drop-shadow-shadow-bg rounded-[10px] p-[26px]">
        ...
        <img className=" w-5/12 xl:w-full" src={contactImg.src} alt="contact us" />
      </div>
    </section>
  )
}
